...
class TestCategoryBasedTags:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("ai-writing-content", {"consumers"}),
            ("ai-productivity", {"consumers"}),
            ("ai-education", {"consumers"}),
            ...
            ("ai-finance-legal", {"enterprises"}),
            ("ai-hr-recruiting", {"enterprises"}),
            ("ai-sales-crm", {"enterprises", "b2b"}),
        ],
    )
